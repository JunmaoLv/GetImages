...
image_width = 800
image_height = 600
rectangle_start_x = 240
rectangle_start_y = 60
...
while True:
    ...
    frame_name = 'iamge shape:({},{},{})'.format(width, height, 3)
    cv2.rectangle(frame, (rectangle_start_x,rectangle_start_y), (rectangle_start_x+image_width, rectangle_start_y+image_height), (0,0,255), 2)
    ...
    if input==ord('q'):
        ...
        frame = frame[rectangle_start_y:rectangle_start_y+image_height, rectangle_start_x:rectangle_start_x+image_width]
        ...
        cv2.putText(frame, pred_class_name, (rectangle_start_x+40, rectangle_start_y+50), cv2.FONT_HERSHEY_TRIPLEX, 2.0, (0, 0, 255), 2)
        frame_name = pred_class_name
